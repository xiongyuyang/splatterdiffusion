...
def denoise_tensor(input_tensor, model, scheduler):
    noisy_tensor = input_tensor + torch.randn_like(input_tensor)

    for t in scheduler.timesteps:
        with torch.no_grad():
            noisy_residual = model(noisy_tensor, t).sample
        previous_noisy_sample = scheduler.step(noisy_residual, t, noisy_tensor).prev_sample
        noisy_tensor = previous_noisy_sample
